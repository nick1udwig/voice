...
use hyperware_process_lib::{Address, println};
struct IdState {}
                                ...
                                >(&mut __seq)? {
                                    ...
                                    _serde::__private::None => {
                                        return _serde::__private::Err(
                                            _serde::de::Error::invalid_length(
                                                0usize,
                                                &"struct SignSignatureHttp with 3 elements",
                                            ),
                                        );
                                    }
                                };
                                ...
                                >(&mut __seq)? {
                                    ...
                                    _serde::__private::None => {
                                        return _serde::__private::Err(
                                            _serde::de::Error::invalid_length(
                                                0usize,
                                                &"struct VerifySignatureHttp with 4 elements",
                                            ),
                                        );
                                    }
                                };
    ...
    async fn sign(&mut self, message: Vec<u8>) -> Result<Vec<u8>, String> {
        {
            ::hyperware_process_lib::print_to_terminal(
                ...
                &::alloc::__export::must_use({
                    let res = ::alloc::fmt::format(format_args!("a"));
                    res
                }),
            );
        };
        let target = make_sign_sys();
        {
            ::hyperware_process_lib::print_to_terminal(
                0,
                &::alloc::__export::must_use({
                    let res = ::alloc::fmt::format(format_args!("b"));
                    res
                }),
            );
        };
